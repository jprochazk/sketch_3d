...
public class sketch_3d extends PApplet {
...
public void move(){
  ...
  if(w){
    ...
    if(a && mr){
      loc.add((sh) ? spd*sin(radians(frotZ+45))*4 : spd*sin(radians(frotZ+45)),(sh) ? spd*cos(radians(frotZ+45))*4 : spd*cos(radians(frotZ+45)),0.0f);
    } 
  ...
  //if moving backward
    ...
    //and also holding right click and the A button
    if(a && mr){
      loc.sub((sh) ? spd*sin(radians(frotZ-45))*4 : spd*sin(radians(frotZ-45)),(sh) ? spd*cos(radians(frotZ-45))*4 : spd*cos(radians(frotZ-45)),0.0f);
    } 
    //and also holding right click and the D button
    else if(d && mr){
      loc.sub((sh) ? spd*sin(radians(frotZ+45))*4 : spd*sin(radians(frotZ+45)),(sh) ? spd*cos(radians(frotZ+45))*4 : spd*cos(radians(frotZ+45)),0.0f);
  ...
  //else, if not moving forward or backward
    ...
    if(a && mr){
      ...
      loc.add((sh) ? spd*sin(radians(frotZ+90))*2 : spd*sin(radians(frotZ+90))/2,(sh) ? spd*cos(radians(frotZ+90))*2 : spd*cos(radians(frotZ+90))/2,0.0f);
    } 
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "sketch_3d" };
    if (passedArgs != null) {
